...
{
    public class CalibrateRate1FWithCaplet
    {
        ...
        public CalibrateRate1FWithCaplet(OneFactorTrinomialShortRateTree.ModelType rateModel, string name, double dtTree, double tEndTree, List<Tuple<double, double>> zrInput, List<Tuple<double, bool, double, double>> capletInput, double dtCap)
        {
            this.name = name;
            this.dtTree = dtTree;
        ...
        public OneFactorTrinomialShortRateTree calibrate()
        {
            ...
            Console.WriteLine("Calibration with Caplet completed ...");
